...
do
   ...
   python3 cnn_intervention_DTMF.py --outputPath $savePath --modelPath $weightsPath --verbose $verbosity --modelId $modelId --interventionType $interventionType --interveneDuration $interveneDuration --subset $testset --interveneAtEnd $interveneAtEnd --interveneAtStart $interveneAtStart --protocalFile $protocal --condition $searchCondition --interveneClass $interveneClass --basePath $audioBasePath
