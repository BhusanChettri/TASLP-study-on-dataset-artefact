...
do
  ...
  for subset in 'train' 'dev' #'eval'  #we do not have eval dtmf annotations
  do
   if [ $subset == 'train' ]; 
    then
   ...
   useAnnotations=$annotationBase/$subset/v2/detailed_annotations/dtmf_last_columns_removed.txt
