function [stat,delta,double_delta]=extract_rfcc(file_path,Fs,Window_Length,NFFT,No_Filter) 
% Function for computing RFCC features 
% Usage: [stat,delta,double_delta]=extract_rfcc(file_path,Fs,Window_Length,No_Filter) 
%
...
%
%Output: stat=Static RFCC (Size: NxNo_Filter where N is the number of frames)
%        delta=Delta RFCC (Size: NxNo_Filter where N is the number of frames)
%        double_delta=Double Delta RFCC (Size: NxNo_Filter where N is the number of frames)
%
