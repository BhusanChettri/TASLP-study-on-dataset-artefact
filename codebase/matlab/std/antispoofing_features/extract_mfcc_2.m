function [stat,delta,double_delta]=extract_mfcc_2(speech,Fs,Window_Length,NFFT,No_Filter) 
...
% Usage: [stat,delta,double_delta]=extract_mfcc(speech,Fs,Window_Length,No_Filter) 
%
